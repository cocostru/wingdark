...
<div id="cart" >
    <h4>Ваша корзина</h4>
    <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="dropdown-toggle btn btn-default"><span id="cart-total"><?php echo $text_items; ?></span></button>
 ...
 <ul class="dropdown-menu pull-right">
    ...
    <li>
      <div>
        ...
        <p class="text-right"><a class="btn btn-orange" href="<?php echo $cart; ?>"> <?php echo $text_cart; ?></a>&nbsp;&nbsp;&nbsp;<a class="btn btn-buy" href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></p>
      </div>
    </li>
    <?php } else { ?>
    <li>
