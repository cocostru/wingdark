...
'email'   => $result['email'],
	...
	protected function getForm() {
		...
		$data['text_disabled'] = $this->language->get('text_disabled');
			...
			$data['token_user_id'] = $this->session->data['token'];
			$data['session_user_id'] = $this->session->data['user_id'];
			if(isset($this->request->get['user_id'])){
				$data['data_user_id'] = $this->request->get['user_id'];
			}else{
				$data['data_user_id'] = "";
			}
		...
		if (isset($this->request->post['firstname'])) {
			...
			if (isset($this->request->post['add_code'])) {
				$data['add_code'] = $this->request->post['add_code'];
			} elseif (!empty($user_info)) {
				$data['add_code'] = $user_info['add_code'];
			} else {
				$data['add_code'] = "";
			}
			if (isset($this->request->post['user_text'])) {
				$data['user_text'] = $this->request->post['user_text'];
			} elseif (!empty($user_info)) {
				$data['user_text'] = $user_info['user_text'];
			} else {
				$data['user_text'] = "";
			}
			if (isset($this->request->post['email_question'])) {
				$data['email_question'] = $this->request->post['email_question'];
			} elseif (!empty($user_info)) {
				$data['email_question'] = $user_info['email_question'];
			} else {
				$data['email_question'] = 1;
			}
			if (isset($this->request->post['badge1'])) {
				$data['badge1'] = $this->request->post['badge1'];
			} elseif (!empty($user_info)) {
				$data['badge1'] = $user_info['badge1'];
			} else {
				$data['badge1'] = "";
			}
			if (isset($this->request->post['badge2'])) {
				$data['badge2'] = $this->request->post['badge2'];
			} elseif (!empty($user_info)) {
				$data['badge2'] = $user_info['badge2'];
			} else {
				$data['badge2'] = "";
			}
			if (isset($this->request->post['badge3'])) {
				$data['badge3'] = $this->request->post['badge3'];
			} elseif (!empty($user_info)) {
				$data['badge3'] = $user_info['badge3'];
			} else {
				$data['badge3'] = "";
			}
			if (isset($this->request->post['badge4'])) {
				$data['badge4'] = $this->request->post['badge4'];
			} elseif (!empty($user_info)) {
				$data['badge4'] = $user_info['badge4'];
			} else {
				$data['badge4'] = "";
			}
			if (isset($this->request->post['badge5'])) {
				$data['badge5'] = $this->request->post['badge5'];
			} elseif (!empty($user_info)) {
				$data['badge5'] = $user_info['badge5'];
			} else {
				$data['badge5'] = "";
			}
