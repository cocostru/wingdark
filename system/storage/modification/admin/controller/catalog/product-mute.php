...
if ( $this->config->get('avail_config_product_edit') == '1' ) {
	...
	protected function getList() {
		...
		$data['delete'] = $this->url->link('catalog/product/delete', 'token=' . $this->session->data['token'] . $url, true);
			...
			$data['separate_permition_products'] = $this->user->hasPermission('modify', 'localisation/order_status');
...
if ($this->db->query("SHOW TABLES LIKE '". DB_PREFIX ."product_extra_field'")->num_rows == 0) {
