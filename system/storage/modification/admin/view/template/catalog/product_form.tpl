...
<div class="form-group">
			<label class="col-sm-2 control-label" for="input-extra_field<?php echo $language['language_id']; ?>">Краткое описание</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" name="product_extra_field[<?php echo $language['language_id']; ?>][extra_field]" placeholder="Enter Your Product Extra Field" id="input-extra_field<?php echo $language['language_id']; ?>"><?php echo isset($product_extra_field[$language['language_id']]) ? $product_extra_field[$language['language_id']]['extra_field'] : ''; ?></textarea>
                    </div>
                 </div>
                  <div class="form-group">
			...
			<?php }else{ ?>
				<?php echo $keyword; ?>
				<input style="display: none;" type="text" name="keyword" value="<?php echo $keyword; ?>" placeholder="<?php echo $entry_keyword; ?>" id="input-keyword" class="form-control" />
			<?php } ?>
			...
			<?php }else{ ?>
				<input style="display: none;" type="text" name="sort_order" value="<?php $sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
			<?php } ?>
			...
			<?php }else{ ?>
				<div style="display: none;" class="well well-sm" style="height: 150px; overflow: auto;">
			<?php } ?>
