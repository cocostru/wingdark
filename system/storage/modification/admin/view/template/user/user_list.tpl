            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
				  ...
				  <td class="text-left"><?php if ($sort == 'user_id') { ?>
                    <a href="<?php echo $sort_user_id; ?>" class="<?php echo strtolower($order); ?>"><?php echo "User ID"; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_user_id; ?>"><?php echo "User ID"; ?></a>
                    <?php } ?></td>
			
			

				  <td class="text-left"><?php if ($sort == 'firstname') { ?>
                    <a href="<?php echo $sort_firstname; ?>" class="<?php echo strtolower($order); ?>"><?php echo "Name"; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_firstname; ?>"><?php echo "Name"; ?></a>
                    <?php } ?></td>
			
			

				  <td class="text-left"><?php if ($sort == 'lastname') { ?>
                    <a href="<?php echo $sort_lastname; ?>" class="<?php echo strtolower($order); ?>"><?php echo "Phone number"; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_lastname; ?>"><?php echo "Phone number"; ?></a>
                    <?php } ?></td>
			
			

				  <td class="text-left"><?php if ($sort == 'email') { ?>
                    <a href="<?php echo $sort_email; ?>" class="<?php echo strtolower($order); ?>"><?php echo "E-Mail"; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_email; ?>"><?php echo "E-Mail"; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
				...
				<td class="text-left"><?php echo $user['lastname']; ?></td>
					...
					<td class="text-right"><a href="<?php echo "mailto:" . $user['email']; ?>" target="_top"><?php echo $user['email']; ?></a></td>
